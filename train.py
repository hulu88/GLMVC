...
def main(args):
    ...
    for i in range(T):
        ...
        criterion = Loss(batch_size, class_num, temperature_f, temperature_l, device,margin=0.01).to(device)
